...
/**
 * Description of MessageFormatter
 *
 * @author Lens
 */
class MessageFormatter extends Component
{
    ...
    public function format($pattern, $parameters, $language)
    {
        $this->_errorCode = 0;
        $this->_errorMessage = '';
        ...
        $newParams = [];
        $pattern = $this->replaceNamedArguments($pattern, $parameters, $newParams);
    ...
    {
        $charset = \LFramework::$application ? \LFramework::$application->_charset : 'UTF-8';
        $depth = 1;
